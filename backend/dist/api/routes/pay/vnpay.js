...
var vnp_ReturnUrl = "http://localhost:4000/pay/vnpay/vnpay_return";
...
router.post('/create_payment_url', function (req, res, next) {
  ...
  var date = new Date();
  var createDate = (0, _moment["default"])(date).format('YYYYMMDDHHmmss');
  var orderId = req.body.orderId;
  var amount = req.body.amount;
  var bankCode = req.body.bankCode;
  var orderInfo = "Thanh toan hoa don ".concat(orderId, ". Thoi gian: ").concat((0, _moment["default"])(date).format('YYYY-MM-DD HH:mm:ss'));
  ...
  var hmac = _crypto["default"].createHmac("sha512", secretKey);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return _axios["default"].get("http://localhost:4000/pay/vnpay/vnpay_ipn?".concat(_qs["default"].stringify(vnp_Params, {
            encode: false
          })));
        case 4:
        ...
        case 13:
          ...
          if (secureHash === signed) {
            ...
            orderInfo = Object.keys(_qs["default"].parse(vnp_Params['vnp_OrderInfo']));
