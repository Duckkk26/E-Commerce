...
var _Cart = _interopRequireDefault(require("../../db/model/Cart.js"));
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import model for product
// Import model for cart
// Import middlewares
var router = exports.router = _express["default"].Router();

// API for getting cart data 
router.get('/get', _fetchUserFromToken.fetchUser, /*#__PURE__*/function () {
...
router.post('/addToCart', _fetchUserFromToken.fetchUser, /*#__PURE__*/function () {
...
router.post('/removeFromCart', _fetchUserFromToken.fetchUser, /*#__PURE__*/function () {
...
router["delete"]('/deleteFromCart', _fetchUserFromToken.fetchUser, /*#__PURE__*/function () {
